...
while True:
    ...
    # ----- EXIT COMMANDS -----
        ...
        print("Bot: I can greet you, answer basic questions, and have a simple conversation!")

    elif user_input in ["your favorite color", "favorite color"]:
       print("Bot: Blue! It's the color of logic. 😄")

    elif user_input in ["tell me a joke", "joke"]:
       print("Bot: Why don't programmers like nature? It has too many bugs! 🐛")
